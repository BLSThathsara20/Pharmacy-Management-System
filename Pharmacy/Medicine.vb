...
Public Class Medicine
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        Medname.Text = DataGridView1.CurrentRow.Cells(1).Value
        Medname.Enabled = False
        Bprice.Text = DataGridView1.CurrentRow.Cells(2).Value
        sellprice.Text = DataGridView1.CurrentRow.Cells(3).Value
        qty.Text = DataGridView1.CurrentRow.Cells(4).Value
        dt.Text = DataGridView1.CurrentRow.Cells(5).Value
        cmpany.Text = DataGridView1.CurrentRow.Cells(6).Value
    ...
    Private Sub delte_Click(sender As Object, e As EventArgs) Handles delte.Click
        ...
        Dim cmd As New SqlCommand("delete from MedTbl where MID = @MedName", con)
